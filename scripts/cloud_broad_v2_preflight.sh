...
candidates = [
    ...
    "careqa_open_perplexity", "meddialog_qsumm_perplexity",
    "meddialog_raw_perplexity", "mediqa_qa2019_perplexity",
    "medtext_perplexity", "mimic_repsum_perplexity",
    "mts_dialog_perplexity", "olaph_perplexity",
