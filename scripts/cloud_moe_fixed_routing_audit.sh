...
audit_one source-13794 \
  "/workspace-SR006.nfs3/hmoe-checkpoints/stage3-time-match-source/$arm" 13794 1
[[ $mode == smoke ]] && { echo EXIT=0; exit 0; }
audit_one original-17242 \
  "/workspace-SR006.nfs3/hmoe-checkpoints/stage3/trunk/$arm" 17242 1
audit_one extension-control-17242 \
  "/workspace-SR006.nfs3/hmoe-checkpoints/stage3-extension-decay-control/extension-decay-control/$arm" 17242 1
audit_one old-time-match-19570 \
  "/home/jovyan/hmoe-checkpoints/stage3-time-match/time-match/$arm" 19570 1
audit_one stretched-19570 \
  "/workspace-SR006.nfs3/hmoe-checkpoints/stage3-time-match-stretched-v1/time-match-stretched/$arm" 19570 0
